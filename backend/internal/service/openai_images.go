...
func (s *OpenAIGatewayService) forwardOpenAIImagesAPIKey(
	...
	if parsed.Stream && isEventStreamResponse(resp.Header) {
		...
		nonStreamBody, nonStreamUsage, nonStreamCount, nonStreamSizes, err := s.readOpenAIImagesNonStreamingResponse(
			upstreamCtx, resp, c, account, parsed,
		)
		if err != nil {
			return nil, err
		}
...
func (s *OpenAIGatewayService) readOpenAIImagesNonStreamingResponse(
	ctx context.Context,
	resp *http.Response,
	c *gin.Context,
	account *Account,
	parsed *OpenAIImagesRequest,
) ([]byte, OpenAIUsage, int, []string, error) {
