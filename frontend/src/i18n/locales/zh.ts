export default {
  ...
  admin: {
    ...
    affiliates: {
      hierarchyDescription: '查看代理邀请树、团队充值和多级差价返利',
      ...
      hierarchy: {
        rootUser: '根代理',
        rootSearchPlaceholder: '搜索邮箱、用户名、用户 ID、邀请码',
        nodeSearch: '树内搜索',
        nodeSearchPlaceholder: '邮箱、用户名、用户 ID、邀请码',
        startAt: '开始日期',
        endAt: '结束日期',
        ...
        addAgent: '添加代理账户',
        agentUser: '代理用户',
        agentSearchPlaceholder: '搜索邮箱、用户名或用户 ID',
        agentRate: '代理返利比例',
        enableAgentAccess: '开启代理层级访问',
        agentNotes: '备注',
        agentNotesPlaceholder: '例如：一级代理-A区推广',
        agentEnabled: '已授权代理',
        agentDisabled: '未授权',
        enableAgent: '开启代理访问',
        disableAgent: '取消代理访问',
        agentSaved: '代理账户已保存',
        agentEnabledSaved: '代理访问已开启',
        agentDisabledSaved: '代理访问已取消',
        editRate: '编辑代理比例',
        currentRate: '当前比例：',
        clearRate: '清除专属比例，回退全局比例',
        newRate: '新比例',
        rateHint: '下级比例不能超过上级比例；若已有直属下级，不能低于直属下级最高有效比例。',
        rateSaved: '代理比例已保存',
        emptyNodes: '暂无匹配节点',
        selectRootFirst: '请选择根代理',
        errors: {
          loadRootsFailed: '加载代理根节点失败',
          loadUsersFailed: '搜索用户失败',
          loadFailed: '加载代理层级失败',
          saveAgentFailed: '保存代理账户失败',
          saveAccessFailed: '保存代理访问权限失败',
          saveRateFailed: '保存代理比例失败',
          AFFILIATE_RATE_EXCEEDS_CAP: '比例不符合层级限制：下级不能超过上级，且不能低于直属下级最高比例',
          INVALID_RATE: '请输入 0-100 之间的比例'
        }
      },
      records: {
        search: '搜索',
