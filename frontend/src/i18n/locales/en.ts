export default {
  ...
  nav: {
    ...
    myAgentTeam: 'My Agent Team',
    affiliateManagement: 'Affiliate Rebates',
    affiliateHierarchy: 'Agent Hierarchy',
  ...
  tutorial: {
    title: 'Tutorial',
    description: 'Generate ready-to-use client configuration by client, model, and endpoint',
    channel: 'Channel',
    model: 'Model',
    client: 'Client',
    apiKey: 'API Key',
    ...
    customEndpoint: 'Custom endpoint {n}',
    noAvailableKey: 'No available OpenAI key',
    noAvailableClaudeKey: 'No available Claude key',
    emptyTitle: 'No available OpenAI API Key',
    emptyDescription: 'Create an enabled API Key assigned to an OpenAI group, then return here to generate the Codex configuration.',
    emptyClaudeTitle: 'No available Claude API Key',
    emptyClaudeDescription: 'Create an enabled API Key assigned to a Claude/Anthropic group, then return here to generate the Claude Code configuration.',
    ...
    nodeInstall: {
      ...
      macosHint: 'For macOS users with Homebrew installed.',
      linuxHint: 'For Ubuntu / Debian users through the NodeSource LTS repository.',
      verify: 'After installation, close and reopen your terminal, then verify the versions:',
      officialDownload: 'Open the official Node.js installer page'
    },
    steps: {
      ...
      createClaudeConfigDir: 'Create and open the config directory. If the .claude directory does not exist, create it first.',
  ...
  affiliate: {
    ...
    hierarchy: {
      description: 'View your agent team, downstream top-ups, and rebates',
      noAccessTitle: 'Agent team access is not enabled',
      noAccessDescription: 'This page is only available to agent accounts enabled by an administrator.',
      startAt: 'Start Date',
      endAt: 'End Date',
      maxDepth: 'Max Depth',
      nodeSearch: 'Team Search',
      nodeSearchPlaceholder: 'Email, username, user ID, or invite code',
      nodeCount: 'Nodes',
      teamSize: 'Team Size',
      teamRecharge: 'Team Top-ups',
      selfRecharge: 'Self Top-ups',
      rebateAmount: 'Rebates Earned',
      user: 'User',
      depth: 'Level',
      parent: 'Parent',
      affCode: 'Invite Code',
      ...
      nthDownline: 'Level {depth} Downline',
      emptyNodes: 'No matching nodes',
      errors: {
        loadAccessFailed: 'Failed to load agent access',
        loadFailed: 'Failed to load agent team',
        AFFILIATE_AGENT_ACCESS_DENIED: 'Agent team access is not enabled for your account',
        AFFILIATE_DISABLED: 'Affiliate rebates are disabled'
      }
    }
  },
  ...
  admin: {
    ...
    affiliates: {
      hierarchyDescription: 'View agent invitation trees, team top-ups, and differential rebates',
      ...
      hierarchy: {
        rootUser: 'Root Agent',
        rootSearchPlaceholder: 'Search email, username, user ID, or invite code',
        nodeSearch: 'Tree Search',
        nodeSearchPlaceholder: 'Email, username, user ID, or invite code',
        startAt: 'Start Date',
        endAt: 'End Date',
        maxDepth: 'Max Depth',
        ...
        customRate: 'Custom',
        globalRate: 'Global',
        addAgent: 'Add Agent Account',
        agentUser: 'Agent User',
        agentSearchPlaceholder: 'Search email, username, or user ID',
        agentRate: 'Agent Rebate Rate',
        enableAgentAccess: 'Enable agent hierarchy access',
        agentNotes: 'Notes',
        agentNotesPlaceholder: 'Example: Tier-1 agent, region A',
        agentEnabled: 'Agent Enabled',
        agentDisabled: 'Not Enabled',
        enableAgent: 'Enable Agent Access',
        disableAgent: 'Disable Agent Access',
        agentSaved: 'Agent account saved',
        agentEnabledSaved: 'Agent access enabled',
        agentDisabledSaved: 'Agent access disabled',
        editRate: 'Edit Agent Rate',
        currentRate: 'Current rate:',
        clearRate: 'Clear custom rate and fall back to global rate',
        newRate: 'New Rate',
        rateHint: 'A child rate cannot exceed its parent rate; if this user has children, it cannot be lower than the highest direct-child effective rate.',
        rateSaved: 'Agent rate saved',
        emptyNodes: 'No matching nodes',
        selectRootFirst: 'Select a root agent',
        errors: {
          loadRootsFailed: 'Failed to load root agents',
          loadUsersFailed: 'Failed to search users',
          loadFailed: 'Failed to load agent hierarchy',
          saveAgentFailed: 'Failed to save agent account',
          saveAccessFailed: 'Failed to save agent access',
          saveRateFailed: 'Failed to save agent rate',
          AFFILIATE_RATE_EXCEEDS_CAP: 'Rate violates hierarchy limits: child rates cannot exceed parent rates and cannot be lower than the highest direct-child rate',
          INVALID_RATE: 'Enter a rate between 0 and 100'
        }
      },
      records: {
        search: 'Search',
