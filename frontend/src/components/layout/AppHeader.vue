<template>
  <header class="glass sticky top-0 z-30 border-b border-gray-200/50 dark:border-dark-700/50">
    <div
      class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6 lg:grid lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] lg:gap-3"
    >
      <!-- Left: Mobile Menu Toggle + Page Title -->
      <div class="flex min-w-0 shrink-0 items-center gap-2 sm:gap-4 lg:justify-self-start">
        <button
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3 lg:justify-self-end">
        <!-- Announcement Bell -->
